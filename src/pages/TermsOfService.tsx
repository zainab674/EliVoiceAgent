            ...
            <div className="prose prose-invert max-w-none space-y-8">
              ...
              <section>
                ...
                <p className="text-zinc-300 leading-relaxed mt-4">
                  <strong className="text-white">Company Information:</strong> These Terms of Service are provided by Shmixi
                  (the "Company", "we", "us", or "our"). Our service is operated under the brand name Shmixi.
                </p>
              </section>
              ...
              <section>
                ...
                <div className="bg-zinc-800/50 border border-zinc-700/50 rounded-lg p-4 space-y-2">
                  ...
                  <p className="text-zinc-300">
                    ...
                    <a href="mailto:contact@shmixi.com" className="text-indigo-400 hover:text-indigo-300 underline">
                      contact@shmixi.com
                    </a>
                  </p>
                </div>
