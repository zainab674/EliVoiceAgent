...
export function CalendarAuthDialog({ children, onSuccess, defaultProvider = "calcom" }: CalendarAuthDialogProps) {
          ...
          <form id="calendar-form" onSubmit={onSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                type="password"
                placeholder={
                  form.provider === "calcom" ? "cal_live_..." :
                    form.provider === "google_calendar" ? "Google Calendar API Key" :
                      form.provider === "outlook_calendar" ? "Outlook Calendar API Key" :
                        "Enter API key"
                }
                value={form.apiKey}
